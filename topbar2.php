...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark" style="height:100%">
    <div class="container">
        ...
        <ul class="navbar-nav mx-auto" style="flex-direction: row;">
            ...
            <span class="navbar-text" style="border-radius: 0 15px 15px 0;background-color:#17a2b8;color:white;height:50px;"><i id="valami"
                                                                                 class='fas fa-gem'
            ...
            <li class="nav-item active">
            <span class="navbar-text" style="border-radius:15px 0 0 15px;background-color:#E344FF;color:white;height:50px"><i id="valami" class='fas fa-battery-half'
