                 ...
                 if ($result->num_rows > 0) {
                     ...
                     while($row = $result->fetch_assoc()) {
                         ...
                         <tr style="text-align: center">
                             ...
                             <td class='clickable-row'  data-href=' <?php if ( $row["barat"] == 1 ) { ?>index.php?page=proff&add=<?php echo $row["name2"]; } else {?>index.php?page=proff&name=<?php echo $row["name2"]; }?>' style="cursor: pointer;" > <?php if($row["barat"] == 10 ) { ?><i class="material-icons" style="font-size:24px;color:green;">check_box</i> <?php } else { ?><i class='fas fa-user' style='font-size:24px;color:white'></i> <?php } ?></td>
